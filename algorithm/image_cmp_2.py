...
from .huffman_full import (compress_huffman, decompress_huffman)
...
def compress_bmp(file_bytes):
    ...
    compressed = compress_huffman(bytes(raw_data))
...
def decompress_bmp(file_bytes):
    ...
    #DEBUG
    print(f"Decompressing: {width}x{height}, {bits_per_pixel} bpp")
    print(f"Compressed data size: {len(compressed_data)} bytes")

    raw_data = decompress_huffman(compressed_data)
